...
- (AVPlayerViewController*)createPlayerViewController:(AVPlayer*)player withPlayerItem:(AVPlayerItem*)playerItem {
    RNnyt360VideoPlayerViewController* playerLayer= [[RNnyt360VideoPlayerViewController alloc] init];
...
- (void)setSrc:(NSDictionary *)source
{
  ...
  __weak RNnyt360Video *weakSelf = self;
...
#pragma mark - RNnyt360VideoPlayerViewControllerDelegate
